" Intro: Vim script about direct source files/dirs selection for netrw commands.
" Title: Direct source files/dirs selection.
" Name: NetrwMarkedSource.vim 
" Help: :he Vale-netrw_fm
...
function! NetrwMarkedSource#MarkedSource()
	let avviso = "remarking partitions; source dirs and/or files"
	echo avviso
endfunction
