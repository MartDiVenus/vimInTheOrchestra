" Intro: Vim script about direct destination directories selection for netrw commands.
" Title: Direct dest dirs selection.
" Name: NetrwMarkedDest.vim 
" Help: :he Vale-netrw_fd
...
function! NetrwMarkedDest#MarkedDest()
	let avviso = "remarking destination dir/dirs"
	echo avviso
endfunction
