...
"  Mart's brushstroke
syn cluster NetrwGroup		contains=netrwHide,netrwSortBy,netrwSortSeq,netrwQuickHelp,netrwVersion,netrwCopyTgt,netrwMartHelp
...
" Mart brushstroke (cambio dell'ufficiale << Quick Help: >> in << Quinck Help1 >>"
syn region netrwQuickHelp	matchgroup=Comment start="Quick Help1:\s\+" end="$"	contains=netrwHelpCmd,netrwQHTopic,@NoSpell	keepend contained
" Mart brushstroke (introduzione del mio Quick Help2)
syn region netrwMartHelp	matchgroup=Comment start="Quick Help2:\s\+" end="$"	contains=netrwHelpCmd,netrwQHTopic,@NoSpell	keepend contained
" Mart brushstroke End
...
" Mart's brushstroke (le voci didascalie dell'aiuto le devo colorare come quelle di default di netrwQHTopic)
syn match  netrwQHTopic		"(marks.*)"			contained skipwhite
syn match  netrwQHTopic		"To not type, meaning ->" 	contained skipwhite
syn match  netrwQHTopic		"(remarks.*)"		 	contained skipwhite
syn match  netrwQHTopic		"(actions.*)"		 	contained skipwhite
" Mart brushstroke End
