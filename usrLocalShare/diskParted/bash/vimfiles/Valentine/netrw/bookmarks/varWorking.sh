...
if [ -d /var/local/netrw ]; then
        if [ -d /var/local/netrw/bookmarks ]; then
                ...
                sudo -S mkdir /var/local/netrw/bookmarks
                sudo -S chown -R root:$USER /var/local/netrw/bookmarks
                sudo chmod -R uga+xrw /var/local/netrw/bookmarks
        fi
else

                sudo -S mkdir /var/local/netrw
		sudo -S mkdir /var/local/netrw/bookmarks
                sudo -S chown -R root:$USER /var/local/netrw
