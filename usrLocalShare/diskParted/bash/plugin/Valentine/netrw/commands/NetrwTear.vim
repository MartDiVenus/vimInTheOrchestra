" Intro: Vim global plugin about files/dirs' contents tearing in X clipboard.
" Title: Netrw !file tearing 
" Name: NetrwTear.vim 
" Help: :he Vale-netrw_ft
...
function! NetrwTear#Tear()
	! ~/.vim/vimfiles/Valentine/netrw/commands/NetrwTearIf.sh
	redraw
endfunction
