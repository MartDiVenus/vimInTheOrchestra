" Intro: Vim script about inverse dest dirs selection for netrw commands.
" Title: Inverse dest dirs selection.
" Name: NetrwInverseMarkedDest.vim 
" Help: :he Vale-netrw__fd
...
function! NetrwInverseMarkedDest#InverseMarkedDest()
	! ~/.vim/vimfiles/Valentine/netrw/commands/inverseMarkedDest.sh
        redraw 
endfunction
