" Intro: Vim script about inverse  source files/dirs selection for netrw commands.
" Title: Inverse source files/dirs selection.
" Name: NetrwInverseMarkedSource.vim 
" Help: :he Vale-netrw__fm
...
function! NetrwInverseMarkedSource#InverseMarkedSource()
	! ~/.vim/vimfiles/Valentine/netrw/commands/inverseMarkedSource.sh
        redraw 
endfunction
