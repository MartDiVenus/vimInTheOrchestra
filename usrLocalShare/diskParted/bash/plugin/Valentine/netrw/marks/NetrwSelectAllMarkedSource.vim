" Intro: Vim script about all files/dirs selection for netrw commands.
" Title: All files/dirs selection.
...
function! NetrwSelectAllMarkedSource#SelectAllMarkedSource()
	! ~/.vim/vimfiles/Valentine/netrw/commands/selectAllMarkedSource.sh
        redraw 
endfunction
