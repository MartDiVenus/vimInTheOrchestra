...
if [ -f /tmp/valeparted-dev ]; then
	...
	echo "Non hai specificato alcuna partizione per accogliere il contenuto che 
sarà della iso.
Uscita forzata."
exit
...
scelta=2
	...
	## sto forzando la scelta perché essendo tale script elemento di un ciclo,
	# per non perdere tempo a ogni iterazione, forzo la scelta.
scelta=1
