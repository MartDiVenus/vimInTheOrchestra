...
/usr/local/share/valentine/diskParted/bash/ISOR/f-sc.sh

else

	## opzione --scl (lista di file ISO da copiare nel file ISO)
if [ -f /tmp/valeparted-listOfFilesToCopy ]; then 
/usr/local/share/valentine/diskParted/bash/ISOR/f-scl.sh

else

	## opzione -f
/usr/local/share/valentine/diskParted/bash/ISOR/f.sh
...
/usr/local/share/valentine/diskParted/bash/ISOR/sc.sh
...
sudo mount -o loop *.iso /mnt/valepartedMnt
...
#/usr/local/share/valentine/diskParted/bash/ISOR/scl.sh
