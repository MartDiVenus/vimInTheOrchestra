" Intro: Vim global plugin about partitions umounting.
" Title: Netrw partitions umounting 
" Name: NetrwMountPart.vim 
" Help: :he Vale-netrw_mo
...
function! NetrwUmountPart#Umount()
	! ~/.vim/vimfiles/Valentine/netrw/commands/valedisks/NetrwUmountPart.sh
        redraw
endfunction
