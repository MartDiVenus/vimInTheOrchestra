...
## udiskctl che è pazzo.
				   ...
				   if [ -f /tmp/ValeDisks/$leggoDevice/$leggoPartizione/mounted ]; then
						...
						## ho bisogno di questo meccanismo, montaggio e smontaggio
					
                                                /home/$curuser/.vim/vimfiles/Valentine/netrw/commands/NetrwMountPartToOff.sh
...
## Ho portato tale istanza fuori dal ciclo, ma non cambia nulla: udiskctl 
# non regge nemmeno l'assenza di un condizionale o di un ciclo, non funziona nemmeno direttamente
# da terminale.
...
rm -f /tmp/valeNetrw-discoEPart /tmp/valeNetrw-devATrattato /tmp/valeNetrw-devIsolato /tmp/valeNetrw-devGrepped /tmp/valeNetrw-bytes
