...
" Title: Netrw all disks turning off, except:
" 	 - the $PWD disk;
" 	 - the filesystem <</>> disk. 
" Name: NetrwOffAllDisks.vim 
" Help: :he Vale-netrw_ba
...
function! NetrwOffAllDisks#OffAll()
	! ~/.vim/vimfiles/Valentine/netrw/commands/valedisks/offAllDisks.sh
        redraw
endfunction
