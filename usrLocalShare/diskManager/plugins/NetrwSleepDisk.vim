" Intro: Vim global plugin about disks turning off.
" Title: Netrw disk turning off 
" Name: NetrwOffDisk.vim 
" Help: :he Vale-netrw_bo
...
function! NetrwSleepDisk#Sleep()
	! ~/.vim/vimfiles/Valentine/netrw/commands/valedisks/NetrwSleepDisk.sh
        redraw
endfunction
