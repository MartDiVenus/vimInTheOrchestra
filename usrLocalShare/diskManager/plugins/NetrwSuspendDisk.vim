" Intro: Vim global plugin about disk suspension.
" Title: Netrw disk suspension
...
function! NetrwSuspendDisk#Suspend()
	! ~/.vim/vimfiles/Valentine/netrw/commands/valedisks/NetrwSuspendDisk.sh
        redraw
endfunction
